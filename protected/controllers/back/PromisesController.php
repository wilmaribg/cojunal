...
class PromisesController extends GxController {
	...
	public function actionCreate() {
		$model = new Promises;
		$this->performAjaxValidation($model, 'promises-form');
		if (isset($_POST['Promises'])) {
			$model->setAttributes($_POST['Promises']);
			if ($model->save()) {
	...
	public function actionUpdate($id) {
		$model = $this->loadModel($id, 'Promises');
		$this->performAjaxValidation($model, 'promises-form');
		if (isset($_POST['Promises'])) {
			$model->setAttributes($_POST['Promises']);
			if ($model->save()) {
	...
	public function actionDelete($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
                    $this->loadModel($id, 'Promises')->delete();
                    if (!Yii::app()->getRequest()->getIsAjaxRequest()){
	...
	public function actionAdmin() {
		$model = new Promises('search');
		$model->unsetAttributes();
		if (isset($_GET['Promises'])){
			$model->setAttributes($_GET['Promises']);
                }
