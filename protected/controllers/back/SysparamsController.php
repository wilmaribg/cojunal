...
class SysparamsController extends GxController {
	...
	public function actionCreate() {
		$model = new Sysparams;
		$this->performAjaxValidation($model, 'sysparams-form');
		if (isset($_POST['Sysparams'])) {
			$model->setAttributes($_POST['Sysparams']);
			if ($model->save()) {
	...
	public function actionUpdate($id) {
		$model = $this->loadModel($id, 'Sysparams');
		$this->performAjaxValidation($model, 'sysparams-form');
		if (isset($_POST['Sysparams'])) {
			$model->setAttributes($_POST['Sysparams']);
			if ($model->save()) {
	...
	public function actionDelete($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
                    $this->loadModel($id, 'Sysparams')->delete();
                    if (!Yii::app()->getRequest()->getIsAjaxRequest()){
	...
	public function actionAdmin() {
		$model = new Sysparams('search');
		$model->unsetAttributes();
		if (isset($_GET['Sysparams'])){
			$model->setAttributes($_GET['Sysparams']);
                }
