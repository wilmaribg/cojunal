...
class PaymentsController extends GxController {
	...
	public function actionCreate() {
		$model = new Payments;
		$this->performAjaxValidation($model, 'payments-form');
		if (isset($_POST['Payments'])) {
			$model->setAttributes($_POST['Payments']);
			if ($model->save()) {
	...
	public function actionUpdate($id) {
		$model = $this->loadModel($id, 'Payments');
		$this->performAjaxValidation($model, 'payments-form');
		if (isset($_POST['Payments'])) {
			$model->setAttributes($_POST['Payments']);
			if ($model->save()) {
	...
	public function actionDelete($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
                    $this->loadModel($id, 'Payments')->delete();
                    if (!Yii::app()->getRequest()->getIsAjaxRequest()){
	...
	public function actionAdmin() {
		...
		if (isset($_GET['Payments'])){
			$model->setAttributes($_GET['Payments']);
                }
