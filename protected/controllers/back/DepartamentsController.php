...
class DepartamentsController extends GxController {
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation($model, 'departaments-form');
		if (isset($_POST['Departaments'])) {
			$model->setAttributes($_POST['Departaments']);
			if ($model->save()) {
	...
	public function actionUpdate($id) {
		$model = $this->loadModel($id, 'Departaments');
		$this->performAjaxValidation($model, 'departaments-form');
		if (isset($_POST['Departaments'])) {
			$model->setAttributes($_POST['Departaments']);
			if ($model->save()) {
	...
	public function actionDelete($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
                    $this->loadModel($id, 'Departaments')->delete();
                    if (!Yii::app()->getRequest()->getIsAjaxRequest()){
	...
	public function actionAdmin() {
		...
		if (isset($_GET['Departaments'])){
			$model->setAttributes($_GET['Departaments']);
                }
