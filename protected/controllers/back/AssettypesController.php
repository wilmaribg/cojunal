...
class AssettypesController extends GxController {
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation($model, 'assettypes-form');
		if (isset($_POST['Assettypes'])) {
			$model->setAttributes($_POST['Assettypes']);
			if ($model->save()) {
	...
	public function actionUpdate($id) {
		$model = $this->loadModel($id, 'Assettypes');
		$this->performAjaxValidation($model, 'assettypes-form');
		if (isset($_POST['Assettypes'])) {
			$model->setAttributes($_POST['Assettypes']);
			if ($model->save()) {
	...
	public function actionDelete($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
                    $this->loadModel($id, 'Assettypes')->delete();
                    if (!Yii::app()->getRequest()->getIsAjaxRequest()){
	...
	public function actionAdmin() {
		$model = new Assettypes('search');
		$model->unsetAttributes();
		if (isset($_GET['Assettypes'])){
			$model->setAttributes($_GET['Assettypes']);
                }
