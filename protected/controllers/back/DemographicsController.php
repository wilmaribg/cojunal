...
class DemographicsController extends GxController {
	...
	public function actionCreate() {
		$model = new Demographics;
		$this->performAjaxValidation($model, 'demographics-form');
		if (isset($_POST['Demographics'])) {
			$model->setAttributes($_POST['Demographics']);
			if ($model->save()) {
	...
	public function actionUpdate($id) {
		$model = $this->loadModel($id, 'Demographics');
		$this->performAjaxValidation($model, 'demographics-form');
		if (isset($_POST['Demographics'])) {
			$model->setAttributes($_POST['Demographics']);
			if ($model->save()) {
	...
	public function actionDelete($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
                    $this->loadModel($id, 'Demographics')->delete();
                    if (!Yii::app()->getRequest()->getIsAjaxRequest()){
	...
	public function actionAdmin() {
		$model = new Demographics('search');
		$model->unsetAttributes();
		if (isset($_GET['Demographics'])){
			$model->setAttributes($_GET['Demographics']);
                }
