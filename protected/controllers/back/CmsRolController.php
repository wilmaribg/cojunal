...
class CmsRolController extends GxController {
	...
	public function actionCreate() {
		$model = new CmsRol;
		if (isset($_POST['CmsRol'])) {
			$model->setAttributes($_POST['CmsRol']);
			if ($model->save()) {
	...
	public function actionUpdate($id) {
		$model = $this->loadModel($id, 'CmsRol');
		if (isset($_POST['CmsRol'])) {
			$model->setAttributes($_POST['CmsRol']);
			if ($model->save()) {
	...
	public function actionDelete($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
                    $this->loadModel($id, 'CmsRol')->delete();
                    if (!Yii::app()->getRequest()->getIsAjaxRequest()){
	...
	public function actionAdmin() {
		$model = new CmsRol('search');
		$model->unsetAttributes();
		if (isset($_GET['CmsRol'])){
			$model->setAttributes($_GET['CmsRol']);
                }
