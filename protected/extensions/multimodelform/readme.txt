    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            $this->widget('ext.multimodelform.MultiModelForm', array(
                ...
                'jsAfterCloneCallback'=>'$.fn.finderDefaultInput',
                'options' => array('limit' => '5'),
                'limitText' => 'Limite de Imagenes:',
                'validatedItems' => $validatedMembers,
                'addItemText' => 'Agregar Imagen',
                'removeText' => 'Eliminar Imagen',
                'addItemAsButton' => true,
                'allowAddItem' => true,
                'allowRemoveItem' => true,
                //'addHtmlOptions'=>array('class'=>'btn btn-primary'),
                'removeHtmlOptions' => array('class' => 'btn btn-danger'),
                'removeConfirm' => 'Desea Eliminar esta Imagen?',
                //array of member instances loaded from db
                'data' => $member->findAll('idcmsicono=:groupId', array(':groupId' => 1)),
            ));
            
            $this->widget('ext.multimodelform.MultiModelForm', array(
                'id' => 'test2', //the unique widget id
                ...
                'removeConfirm' => 'Desea Eliminar esta Imagen?',
                //array of member instances loaded from db
                'data' => $member2->findAll('idcmsrol=:groupId', array(':groupId' => 1)),
            ));
            ?>
        </div>
    </div>
