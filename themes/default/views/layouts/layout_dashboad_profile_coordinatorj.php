...
<body>
  ...
  <section class="content_all">
    ...
    <nav id="nav-mobile" class="side-nav fixed">
      ...
      <ul>
        <li>
          <a href="<?php echo Yii::app()->baseUrl.'/coordinatorj/campanas' ?>" class="waves-effect waves-light">
            <i class="fa fa-home" aria-hidden="true"></i> Campañas
          </a>
        </li>
        <li>
          <a href="<?php echo Yii::app()->baseUrl.'/coordinatorj/cartera' ?>" class="waves-effect waves-light">
            <i class="fa fa-users" aria-hidden="true"></i> Cartera
          </a>
        </li>
        <li>
          <a href="<?php echo Yii::app()->baseUrl.'/coordinatorj/asesores' ?>" class="waves-effect waves-light">
            <i class="fa fa-home" aria-hidden="true"></i> Asesores
          </a>
        </li>
        <li>
