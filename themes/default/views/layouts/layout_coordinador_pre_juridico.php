<?php
  ...
  // Falta configurar el nombre de usuario
...
<body>
  ...
  <section class="content_all">
    ...
    <nav id="nav-mobile" class="side-nav fixed">
      ...
      <ul>
        <li>
          <a href="<?php echo Yii::app()->baseUrl;?>/dashboard" class="waves-effect waves-light" id="wallets">
            <i class="fa fa-users" aria-hidden="true"></i> 
            Campañas
        <li>
          <a href="<?php echo Yii::app()->baseUrl;?>/campaign" class="waves-effect waves-light" id="reports">
            <i class="fa fa-calendar-o" aria-hidden="true"></i> 
            Cartera 
          </a>
        </li>
        <li>
          <a href="<?php echo Yii::app()->baseUrl;?>/database" class="waves-effect waves-light" id="fileUpload">
            <i class="fa fa-file-text-o" aria-hidden="true"></i> 
            <span class="inline">Asesores</span>
          </a>
        </li>
        <li>
          <a href="<?php echo Yii::app()->baseUrl;?>/logout" class="waves-effect waves-light">
            <i class="fa fa-lock" aria-hidden="true"></i> 
            <?=Yii::t("menu","cerrarSesion")?>
          </a>
        </li>
      </ul>
      <?php 
