...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('advisers-campaigns-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('booster.widgets.TbGridView', array(
        ...
        //'rowCssClassExpression'=>'"items[]_{$data->idAvidsersCampaign}"',
        ...
        'columns' => array(
			array(
				'name'=>'idAdvisers',
				'value'=>'GxHtml::valueEx($data->idAdvisers0)',
                                'filter'=>GxHtml::listDataEx(Advisers::model()->findAllAttributes(null, true)),
				),
			array(
				'name'=>'idCampaign',
				'value'=>'GxHtml::valueEx($data->idCampaign0)',
                                'filter'=>GxHtml::listDataEx(Campaigns::model()->findAllAttributes(null, true)),
				),
		array(
