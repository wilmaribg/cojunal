...
?>
	...
	<?php echo $form->errorSummary($model, '<button type="button" class="close" data-dismiss="alert">&times;</button>', null, array('class'=>'alert alert-danger')); ?>
        <div class="row">
            ...
            <?php echo $form->labelEx($model,'feeRate'); ?>
            <?php echo $form->textField($model, 'feeRate', array('class'=>'form-control input-block-level')); ?>
            <?php echo $form->error($model,'feeRate'); ?>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
            <?php echo $form->labelEx($model,'interestRate'); ?>
            <?php echo $form->textField($model, 'interestRate', array('class'=>'form-control input-block-level')); ?>
            <?php echo $form->error($model,'interestRate'); ?>
            </div>
        </div>
        <hr/>
        <div class="row">
            ...
            <?php echo $form->textField($model, 'appName', array('class'=>'form-control input-block-level')); ?>
