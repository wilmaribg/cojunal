...
<?php $this->widget('booster.widgets.TbGridView', array(
        ...
        //'rowCssClassExpression'=>'"items[]_{$data->idAuthAssignment}"',
        ...
        'columns' => array(
			...
			array(
				'name'=>'itemname',
				'value'=>'GxHtml::valueEx($data->itemname0)',
                                'filter'=>GxHtml::listDataEx(AuthItem::model()->findAllAttributes(null, true)),
				),
		array(
