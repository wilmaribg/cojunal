...
<?php $this->widget('booster.widgets.TbGridView', array(
        ...
        //'rowCssClassExpression'=>'"items[]_{$data->idCity}"',
        ...
        'columns' => array(
			...
			array(
				'name'=>'idDepartament',
				'value'=>'GxHtml::valueEx($data->idDepartament0)',
                                'filter'=>GxHtml::listDataEx(Departaments::model()->findAllAttributes(null, true)),
				),
		array(
