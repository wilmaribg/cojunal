...
<?php $this->widget('booster.widgets.TbGridView', array(
        ...
        //'rowCssClassExpression'=>'"items[]_{$data->idPayment}"',
        ...
        'columns' => array(
			...
			array(
				'name'=>'idPaymentType',
				'value'=>'GxHtml::valueEx($data->idPaymentType0)',
                                'filter'=>GxHtml::listDataEx(Paymentypes::model()->findAllAttributes(null, true)),
				),
			*/
		array(
