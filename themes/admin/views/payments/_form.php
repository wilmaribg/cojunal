...
?>
	...
	<?php echo $form->errorSummary($model, '<button type="button" class="close" data-dismiss="alert">&times;</button>', null, array('class'=>'alert alert-danger')); ?>
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
            <?php echo $form->labelEx($model,'dPayment'); ?>
            <?php echo $form->textField($model, 'dPayment', array('class'=>'form-control input-block-level')); ?>
            <?php echo $form->error($model,'dPayment'); ?>
            </div>
        </div>
        <hr/>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
            <?php echo $form->labelEx($model,'idPaymentType'); ?>
            <?php echo $form->dropDownList($model, 'idPaymentType', GxHtml::listDataEx(Paymentypes::model()->findAllAttributes(null, true))); ?>
            <?php echo $form->error($model,'idPaymentType'); ?>
            </div>
        </div>
        <hr/>
