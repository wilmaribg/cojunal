...
?>
	...
	<?php echo $form->errorSummary($model, '<button type="button" class="close" data-dismiss="alert">&times;</button>', null, array('class'=>'alert alert-danger')); ?>
        <div class="row">
            ...
            <?php echo $form->labelEx($model,'googleDirection'); ?>
            <?php echo $form->textField($model, 'googleDirection', array('class'=>'form-control input-block-level')); ?>
            <?php echo $form->error($model,'googleDirection'); ?>
            </div>
        </div>
