...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('cms-help-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('booster.widgets.TbGridView', array(
        ...
        //'rowCssClassExpression'=>'"items[]_{$data->idcmshelp}"',
        ...
        'columns' => array(
			...
			array(
                        'name' => 'contenido', 
                        'type'=>'raw', 
                        'value'=> '$data->contenido !== null ? $data->contenido : null'
                    ),
			array(
                        'name' => 'link', 
                        'type'=>'raw', 
                        'value'=> '$data->link !== null ? GxHtml::link($data->link, $data->link) : null'
                    ),
			'fecha_creacion',
		array(
