...
$this->menu = array(
	...
	array('label' =>'<i class="fa fa-th"></i> ' . Yii::t('app', 'Administrar') . ' ' . $model->label(2), 'url'=>array('admin')),
        array('label'=>'<i class="fa fa-trash-o"></i> '. Yii::t('app', 'Eliminar') . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->idEffect), 'confirm'=>Yii::t('app', 'Seguro que desea borrar este elemento?'))),
);
