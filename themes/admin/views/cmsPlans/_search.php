	...
	'method' => 'get',
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <?php echo $form->textField($model, 'title', array('class'=>'form-control input-block-level')); ?>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <?php echo $form->textField($model, 'items', array('class'=>'form-control input-block-level')); ?>
            </div>
        </div>
        <hr/>
